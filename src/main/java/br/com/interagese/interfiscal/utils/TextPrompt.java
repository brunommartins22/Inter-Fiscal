...
public class TextPrompt extends JLabel
    ...
    public static void installPromptText(String text, JTextComponent component) {
        TextPrompt textPrompt = new TextPrompt(text, component);
        textPrompt.changeStyle(Font.ITALIC + Font.BOLD);
